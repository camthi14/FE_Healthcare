...
export type GetRoomCompleted = SuccessResponseProp<IRoom[], Pagination>;
export type AddEditPayloadRoom = {
  type: "add" | "edit";
  data: IRoom;
  resetData: () => void;
};
...
const roomSlice = createSlice({
  ...
  reducers: {
    ...
    getCompleted: (state, { payload: { metadata, options } }: PayloadAction<GetRoomCompleted>) => {
    ...
    addEditStart: (state, _: PayloadAction<AddEditPayloadRoom>) => {
      state.loading = "pending";
