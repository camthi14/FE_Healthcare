...
export type GetDepartmentCompleted = SuccessResponseProp<IDepartment[], Pagination>;
export type AddEditPayloadDepartment = {
  type: "add" | "edit";
...
const departmentSlice = createSlice({
  ...
  reducers: {
    ...
    getCompleted: (
      state,
      { payload: { metadata, options } }: PayloadAction<GetDepartmentCompleted>
    ) => {
    ...
    addEditStart: (state, _: PayloadAction<AddEditPayloadDepartment>) => {
      state.loading = "pending";
