...
import { IMedicineData, MedicinePayloadAdd } from "~/models";
...
export type GetMedicineCompleted = SuccessResponseProp<IMedicineData[], Pagination>;
export type AddEditPayloadMedicine = {
  type: "add" | "edit";
  data: MedicinePayloadAdd;
  resetData: () => void;
};
...
const medicineSlice = createSlice({
  ...
  reducers: {
    ...
    getCompleted: (
      state,
      { payload: { metadata, options } }: PayloadAction<GetMedicineCompleted>
    ) => {
    ...
    addEditStart: (state, _: PayloadAction<AddEditPayloadMedicine>) => {
      state.loading = "pending";
